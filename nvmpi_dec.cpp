...
//--------------------------------------------------------------------
static void respondToResolutionEvent(v4l2_format &format, v4l2_crop &crop,nvmpictx* ctx)
{
...
int nvmpi_decoder_close(nvmpictx* ctx)
{
    ...
    delete ctx->mutex;
    ctx->mutex = nullptr;
    delete ctx->has_frame_cv;
    ctx->has_frame_cv = nullptr;
    delete ctx->frame_pools;
    ctx->frame_pools = nullptr;
